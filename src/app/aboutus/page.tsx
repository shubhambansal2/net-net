    ...
    return (
        <div
            ...
            <div className="flex flex-col items-center justify-center lg:mt-40 mt-80">
                ...
                <div
                    className="ml-2 mr-2 md:ml-20 md:mr-20  md:text-xl lg:text:xl xl:text-xl text-neutral-600 dark:text-neutral-400 font-bold mt-10">
                    {words1}
                    <br></br>
                    <br></br>
                    {words2}
      ...
      <TextGenerateEffect words={words3} delay = {18000} /> */}
                <a href="/contactus">
                    <button
                        className="px-4 py-2  rounded-md border border-black bg-white text-black text-sm hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] mt-10 transition duration-200" >
                        Contact Us
                    </button>
                </a>
            </div>
