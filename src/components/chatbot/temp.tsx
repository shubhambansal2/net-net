...
//         textarea.style.height = 'auto'; // Reset height to calculate content
...
//                 {/* Chat with LLM */}
//                 <div ref={chatContainerRef} className={`flex-1 flex ${showCards ? 'items-center justify-center' : 'items-start mt-5'}`}>
//
//                 {conversation.map((item, index) => (
//                         <div key={index} className="flex flex-col items-center mb-2 w-full">
//                             <div className="question p-4 py-2 mb-4 shadow-md self-end bg-white rounded-full">
//                                 {item.question}
//                             </div>
...
//
//                         <div className="flex-1"> {/* Ensure button is right-aligned */}
//
//                         </div>
//
...
//                                 // style={{height: '1.5em', maxHeight: '8em'}}
//                             />
//                         </div>
//
//                         <div className="self-end flex-1 "> {/* Ensure button is right-aligned */}
