...
export function WobbleBlogCards() {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-1 gap-4 max-w-7xl mx-auto">
      <a href="/blog/rag">
        <WobbleCard
        containerClassName="col-span-2 lg:col-span-2 h-full bg-pink-800 min-h-[500px] lg:min-h-[300px]"
        className=""
        >
      ...
      <a href="/chatbot">
       <WobbleCard containerClassName="col-span-1 lg:col-span-1 bg-red-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
      ...
      <a href="/contactus">
      <WobbleCard containerClassName="col-span-1 mt-5 min-h-[300px]">
